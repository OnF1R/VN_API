...
namespace VNAPI.Migrations
{
    ...
    [Migration("20240707173044_AddCommentsAndAddVisualNovelColumns")]
    partial class AddCommentsAndAddVisualNovelColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VN_API.Models.VisualNovelComment", b =>
                {
                    ...
                    b.Property<Guid?>("VisualNovelCommentId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("VisualNovelCommentId");
            ...
            modelBuilder.Entity("VN_API.Models.VisualNovelComment", b =>
                {
                    b.HasOne("VN_API.Models.VisualNovelComment", null)
                        .WithMany("Replies")
                        .HasForeignKey("VisualNovelCommentId");
                });
